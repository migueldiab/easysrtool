...
-- -----------------------------------------------------
-- Table `mydb`.`forms_template`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`forms_template` ;

CREATE  TABLE IF NOT EXISTS `mydb`.`forms_template` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`form_fields_template` ;
...
CREATE  TABLE IF NOT EXISTS `mydb`.`form_fields_template` (
  ...
  CONSTRAINT `form_fileds`
    FOREIGN KEY (`form_id` )
    REFERENCES `mydb`.`forms_template` (`form_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Form_instance` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`form_fields_instance` ;
